...
#def start_server():
#	os.chdir('/home/webapp/static/media')
...
@app.route('/')
def form():
    mediapath='/home/webapp/static/media/'+random.choice([item for item in os.listdir('/home/webapp/static/media') if item[-4:].lower() in ('.mp3','.wav','.mp4')])
